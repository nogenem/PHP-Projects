<?php
/**
 * CineMoviesController - Controlador da page de filmes do site
 */
class CineMoviesController extends MainController
{
    ...
    public function index() {
		// Configs da page
		$this->title = 'Cine Movies';
		$this->url = HOME_URI.'cine-movies';
		$this->view_config = [
			'disabled_fields'=>['midia_week_day'],
			'tabs'=>['not_released', 'to_see', 'already_saw'],
		];
