<?php
/**
 * ManagSiteMVC - Gerencia Models, Controllers e Views
 *
...
class ManagSiteMVC
{
	...
	public function __construct () {
		...
		// Seta o path para o arquivo 404
		$this->not_found = file_build_path(PRIVATE_ABSPATH, 'includes', '404.php'); 
		...
		if ( ! $this->controlador ) {
			...
			require_once file_build_path(PRIVATE_ABSPATH, 'controllers', 'home-controller.php');
		...
		$controller_path = file_build_path(PRIVATE_ABSPATH, 'controllers', "{$this->controlador}.php");
